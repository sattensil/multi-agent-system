...
class LinkedInPostManager:
    ...
    async def _search_tech_news(self, topics: List[str], num_posts: int = 5) -> List[Dict[str, str]]:
        ...
        for topic in topics:
            ...
            params = {
                ...
                "apiKey": news_api_key,
                "excludeDomains": "gizmodo.com" # Exclude Gizmodo as per user preference
            }
    ...
    async def _write_post_drafts(self, news_articles: List[Dict[str, str]]) -> List[Dict[str, str]]:
        ...
        for article in news_articles:
            ...
            11. Maintain a MODERATE POLITICAL BIAS - avoid extreme political positions
            12. DO NOT use dashes in the text - use other punctuation instead
            13. Start with a POWERFUL HOOK - use a bold statement, surprising fact, or provocative question
            14. Break up text with line breaks for better readability
            15. Consider using numbered lists or bullet points for key points
            16. Make sure the first 2-3 lines are compelling enough to make readers click 'See more'
            17. DO NOT sound like text generated by an AI - be authentic and human
            18. Share a personal insight or experience related to the topic when relevant
            """
    ...
    async def _edit_posts(self, post_drafts: List[Dict[str, str]]) -> List[Dict[str, str]]:
        ...
        for draft in post_drafts:
            ...
            {messaging_str}
            9. End with a provocative question that invites debate or discussion
            10. Maintain a MODERATE POLITICAL BIAS - avoid extreme political positions
            11. DO NOT use dashes in the text - use other punctuation instead
            12. Create a STRONG OPENING HOOK that captures attention immediately
            13. Improve the structure with better paragraph breaks and formatting
            14. Make sure the first 2-3 lines are compelling enough to make readers click 'See more'
            15. Add elements that encourage comments and engagement
            16. DO NOT sound like text generated by an AI - be authentic and human
            17. Use strategic line breaks to improve readability and engagement
    ...
    async def _revise_posts(self, edited_posts: List[Dict[str, str]]) -> List[Dict[str, str]]:
        ...
        for post in edited_posts:
            ...
            8. Maintain a MODERATE POLITICAL BIAS - avoid extreme political positions
            9. DO NOT use dashes in the text - use other punctuation instead
            10. Perfect the OPENING HOOK to make it impossible to scroll past
            11. Structure the post for maximum readability with strategic line breaks
            12. Consider using one of these viral formats if appropriate:
               a. A bold statement that challenges common beliefs
               b. A personal story that relates to the news topic
               c. A debunking of a common misconception
               d. A practical how-to or actionable advice
               e. A thought-provoking question that sparks discussion
            13. DO NOT sound like text generated by an AI - be authentic and human
            14. Make sure the post flows naturally from point to point
